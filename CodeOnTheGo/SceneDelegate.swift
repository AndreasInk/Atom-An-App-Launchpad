...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    @State var edit = true
    @State var stacks = [Stacks(id: UUID(), type: "VStack {", componets: [Componets]())]
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let contentView = AppsView()//EditingView(edit: $edit)//SFSymbolsView(componet: $componet)//EditingView(edit: $edit)
